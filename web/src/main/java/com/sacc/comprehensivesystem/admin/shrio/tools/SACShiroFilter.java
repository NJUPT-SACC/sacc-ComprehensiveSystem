...
public class SACShiroFilter extends BasicHttpAuthenticationFilter {
    static Logger logger = LoggerFactory.getLogger(SACShiroFilter.class);
    ...
    protected boolean executeLogin(ServletRequest request, ServletResponse response) {
        ...
        SACToken token = new SACToken(authKey);
    ...
    private void response401(ServletRequest req, ServletResponse resp) {
        try {
            ...
            String path = req.getServletContext().getContextPath() + "/ComprehensiveSystem/401";
